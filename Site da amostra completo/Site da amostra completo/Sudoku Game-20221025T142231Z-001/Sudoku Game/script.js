...
//direciona para a página de tutorial de sudoku

function help(){
    window.open(
        "https://sudoku.com/pt/como-jogar/regras-do-sudoku/", "_blank");
}
var level;
var choosen;


// cria o quadro de jogo fácil
...
//comando para checar a resposta
var id=setInterval(() => {
    if (level=="easy"){
...
//tem a função de iniciar um novo jogo
